...
1. How can I configure the WordPress plugin?

   Once you activate the plugin, go to the settings page ( It is under Settings => Dub ) and enter your Dub API key. You can find instructions on how to create an API key [on our website](https://dub.co/docs/api-reference/tokens).
